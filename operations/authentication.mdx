...
export const QuickstartCard = ({ title, icon, href, children, selected }) => {
  ...
  return (
  <a href={href} className="group" style={{ textDecoration: 'none', color: 'inherit', display: 'block' }}>
...
<Columns cols={3}>
  ...
  <QuickstartCard title="CLI" icon="terminal" href="/cli/operations/authentication" selected={true}>
    Command line
  </QuickstartCard>
