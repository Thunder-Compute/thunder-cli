...
╰─────────────────────────────────────────────────────────────────────────────╯
	...
	output.WriteString("\n")
	output.WriteString("  ")
	output.WriteString(CommandStyle.Render("tnr scp myfile.py 0:/home/ubuntu/"))
	output.WriteString("\n\n")
	...
	output.WriteString("\n")
	output.WriteString("  ")
	output.WriteString(CommandStyle.Render("tnr scp 0:/home/ubuntu/results.txt ./"))
	output.WriteString("\n\n")
	...
	output.WriteString("\n")
	output.WriteString("  ")
	output.WriteString(CommandStyle.Render("tnr scp file1.py file2.py config.json 0:/home/ubuntu/"))
	output.WriteString("\n\n")
	...
	output.WriteString("\n")
	output.WriteString("  ")
	output.WriteString(CommandStyle.Render("tnr scp -r ./my-project/ 0:/home/ubuntu/projects/"))
	output.WriteString("\n\n")
	...
	output.WriteString("\n")
	output.WriteString("  ")
	output.WriteString(CommandStyle.Render("tnr scp -r 0:/home/ubuntu/data/ ./local-data/"))
	output.WriteString("\n\n")
