...
╰─────────────────────────────────────────────────────────────────────────────╯
	...
	output.WriteString("\n")
	output.WriteString("  ")
	output.WriteString(CommandStyle.Render("tnr create"))
	output.WriteString("\n\n")
	...
	output.WriteString("\n")
	output.WriteString("  ")
	output.WriteString(CommandStyle.Render("tnr create --mode prototyping --gpu t4 --vcpus 8 --template ubuntu-22.04 --disk-size-gb 100"))
	output.WriteString("\n\n")
	...
	output.WriteString("\n")
	output.WriteString("  ")
	output.WriteString(CommandStyle.Render("tnr create --mode production --num-gpus 2 --template pytorch --disk-size-gb 500"))
	output.WriteString("\n\n")
	...
	output.WriteString("\n")
	output.WriteString("  ")
	output.WriteString(CommandStyle.Render("tnr create --mode prototyping --gpu a100 --vcpus 16 --save-preset my-setup"))
	output.WriteString("\n\n")
	...
	output.WriteString("\n")
	output.WriteString("  ")
	output.WriteString(CommandStyle.Render("tnr create --preset my-setup"))
	output.WriteString("\n\n")
